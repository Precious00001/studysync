...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER\Documents\new alx project\StudySync'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER\Documents\new alx project\StudySync\Scripts\deactivate.nu'
